//taken from >> https://github.com/silvestrodecaro/microsoft-account-creator

const { plugin } = require('puppeteer-with-fingerprints');
const fs = require("fs");
const config = require('../microsoft-account-creator/src/config');
const log = require('../microsoft-account-creator/src/Utils/log');
const recMail = require('../microsoft-account-creator/src/Utils/recMail');
